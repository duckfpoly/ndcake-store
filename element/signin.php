...
<div class="col-md-1 nav-item">
    <a href="../">
        <button type="button" class="btn btn-outline-light"><<< Quay lại trang chủ</button>
    </a>
</div>
    <div class="container">
        <h3 class="text-center">NDMOONCAKE - Đăng nhập</h3>
        <div class="ready__started-box">
            <form method="post" class="main__form">
                ...
                <div class="col-md-12 d-flex ">
                    ...
                    <span>Bạn chưa có tài khoản ?</span> <a href="signup.php">Đăng ký ngay !</a>

                    </div>
                    <div class="col-6 d-flex justify-content-end">
                        <a href="request_reset_pass.php">Quên mật khẩu?</a>
                    </div>
                </div>
                <br>
                <div class="text-center">
                    <button type="submit" class=" btn btn-get" name="signin"><span>Đăng nhập</span></button>
                </div>
            </form>
        </div>
    </div>
